                ...
                if(str.equals("new")) {
                    ...
                    //Analyze the move
                        ...
                        if(!TTT.boardIsFull()&&!TTT.isAWin(TTT.COMPUTER)&&!TTT.isAWin(TTT.HUMAN)&&play) {
                            do {
                                //choosing the best computer move then assigning it to teh row and column
                                bestMove=TTT.chooseMove(TTT.COMPUTER,Integer.MIN_VALUE,Integer.MAX_VALUE);
                                rowAI=bestMove.row;
                                colAI_Int=bestMove.column;
                                switch(colAI_Int) {
